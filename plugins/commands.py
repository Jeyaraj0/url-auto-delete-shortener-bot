...
async def start(client, message):
    if message.chat.type in [enums.ChatType.GROUP, enums.ChatType.SUPERGROUP]:
        buttons = [
            [
                InlineKeyboardButton('⚡ UᎮDΛTΞS ⚡', url='https://t.me/Customer_Support_Group')
            ],
            [
                InlineKeyboardButton('⚡ FOLLOW ⚡', url=f"https://t.me/tamilcinehub"),
            ],
            [
    ...
    if len(message.command) != 2:
        buttons = [[
            ...
            InlineKeyboardButton('⚡ FOLLOW ⚡', url='https://t.me/tamilcinehub'),
            InlineKeyboardButton('🤖 UᎮDΛTΞS 🤖', url='https://t.me/Customer_Support_Group')
            ],[
    ...
    await client.send_cached_media(
        ...
        file_id=file_id,
        caption=f_caption,
        reply_markup=InlineKeyboardMarkup( [ [ InlineKeyboardButton('JOIN CHANNEL', url='https://t.me/tamilcinehub') ] ] ),
        protect_content=True if pre == 'filep' else False,
        )
