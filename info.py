...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '5101420668').split()]
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '0').split()]
auth_users = [int(user) if id_pattern.search(user) else user for user in environ.get('AUTH_USERS', '5101420668').split()]
...
DOWNLOAD_TEXT_URL = "https://t.me/Customer_Support_Group"

   # Custom Caption Under Button #
CAPTION_BUTTON = "FOLLOW"
CAPTION_BUTTON_URL = "https://t.me/tamilcinehub"
